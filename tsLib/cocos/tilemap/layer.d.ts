...
declare namespace cc {
    ...
    export class TMXLayer extends SpriteBatchNode {
         ...
         * @return {cc.Sprite}
         */
        getTileAt(positionOrX: Point | number, y?: number) : Sprite;
         ...
         * @return {number}
         */
        getTileGIDAt(positionOrX: Point | number, y?: number) : number;
         ...
         * @return {number}
         */
        getTileFlagsAt(positionOrX: Point | number, y?: number) : number;
