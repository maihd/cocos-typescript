...
var GMMGamePlayLayer = cc.Layer.extend({
    ...
    ctor: function () {
        ...
        this.matrixOnet.onCompletedCallback = function () {
            _this.showPopupComppleted();
        };
    ...
    initUI: function () {
        ...
        var pnlMoney = this.pnlTop.getChildByName("pnlMoney");
        var pnlLevel = this.pnlTop.getChildByName("pnlLevel");
    ...
    initForResolution: function () {
        ...
        var mainSize = cc.size(size.width, size.height - this.pnlTop.getContentSize().height);
        mainSize.width -= 20;
        mainSize.height -= 20;
    ...
    reloadSoundBtn: function () {
        var sp = this.btnSound.getChildByName("icon");
        if (!getSound()) {
        ...
        if (GMMGameUtils.makeEffectButton(pRef, touchType, 1.0, 0.9)) {
            ...
            if (pRef === this.btnPause) {
                ...
                if (this.matrixOnet.onHint() === true) {
                    var numHint = getPrefInteger(PREF_LOG_NUM_HINT) - 1;
    ...
    showPopupPause: function () {
        var _this = this;
        this.onTouchEnabled(false);
        var popup = new GMMPopupPause();
        popup.onResumeCallback = function () {
            _this.onResume();
        };
        popup.onRestartCallback = function () {
            _this.onPlay();
        };
        popup.onHomeCallback = function () {
            _this.onHome();
        };
    ...
    showPopupPlay: function () {
        var _this = this;
        this.onTouchEnabled(false);
        var popup = new GMMPopupBeginner();
        popup.onPlayCallback = function () {
            _this.onPlay();
        };
        this.addChild(popup, ZORDER_POPUP);
    ...
    showPopupContinue: function () {
        var _this = this;
        this.onTouchEnabled(false);
        var popup = new GMMPopupContinue();
        popup.onPlayCallback = function () {
            _this.onPlay();
        };
        popup.onResetCallback = function () {
            _this.currLevel = 1;
            var obj = { size: 0, nCol: 0, nRow: 0 };
            _this.makeOnetData(obj);
            _this.onPlay();
        };
        this.addChild(popup, ZORDER_POPUP);
    ...
    showPopupComppleted: function () {
        var _this = this;
        this.onTouchEnabled(false);
        var popup = new GMMPopupCompleted(this);
        popup.onNextCallback = function () {
            _this.onPlay();
        };
        popup.onHomeCallback = function () {
            _this.onHome();
        };
        popup.onUpgradeDataCallback = function (nAddScore, nAddLevel) {
            _this.currLevel += nAddLevel;
            _this.totalScore += nAddScore;
        };
        this.addChild(popup, ZORDER_POPUP);
        var bonus = 32000;
        var nStar = 3;
        if (this.currTime > this.maxTime / 2) {
            nStar = 3;
        }
        else if (this.currTime > this.maxTime / 3) {
            nStar = 2;
            bonus = 18000;
    ...
    showPopupGameOver: function () {
        var _this = this;
        this.onTouchEnabled(false);
        var popup = new GMMPopupGameOver();
        popup.onAgainCallback = function () {
            _this.onPlay();
        };
        popup.onMenuCallback = function () {
            _this.onHome();
        };
        this.addChild(popup, ZORDER_POPUP);
    ...
    makeOnetData: function (obj) {
        ...
        var xStart = size.width - 80;
        var yStart = size.height - 80;
    ...
    setNumberOnButton: function (nBtn, number) {
        var notify = nBtn.getChildByName("spNumber");
        if (notify) {
            if (number <= 0) {
                notify.setVisible(false);
            }
            else {
                var text = notify.getChildByName("text");
                if (text) {
